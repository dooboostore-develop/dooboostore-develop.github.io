...
export class IndexRouteComponent extends ComponentBase<any> implements OnRawSetRendered {
  ...
  // onRawSetRendered(rawSet: RawSet, otherData: OnRawSetRenderedOtherData): void {
  //   console.log('vv------,', otherData);
  //   console.log('vv', this.domRenderConfig?.window.document.querySelector('.wow'));
  // }

  // onBeforeReturnSet(a: any,b: any,c: any,d: any) {
  //   console.log('vvvvzv',a,b,c,d);
  // }
