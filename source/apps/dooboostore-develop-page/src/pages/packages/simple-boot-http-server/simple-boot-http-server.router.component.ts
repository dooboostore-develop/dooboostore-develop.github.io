...
import { SimpleBootHttpServerRouteComponent } from "./simple-boot-http-server.route.component";
...
import template from "./simple-boot-http-server.router.component.html";
import styles from "./simple-boot-http-server.router.component.css";
...
@Router({
  path: "/simple-boot-http-server",
  route: {
    "": "/",
    "/": SimpleBootHttpServerRouteComponent,
  },
})
@Component({
  template,
  styles: [styles],
  using: [SimpleBootHttpServerRouteComponent, projectComponent],
})
export class SimpleBootHttpServerRouterComponent extends ComponentRouterBase {
