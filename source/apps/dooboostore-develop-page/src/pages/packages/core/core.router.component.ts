...
import { CoreRouteComponent } from "./core.route.component";
...
import template from "./core.router.component.html";
import styles from "./core.router.component.css";
...
@Component({
  template,
  styles: [styles],
  using: [CoreRouteComponent, projectComponent],
})
export class CoreRouterComponent extends ComponentRouterBase {
