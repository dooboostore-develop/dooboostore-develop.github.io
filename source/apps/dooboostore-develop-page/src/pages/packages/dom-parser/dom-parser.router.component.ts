...
import { DomParserRouteComponent } from "./dom-parser.route.component";
...
import template from "./dom-parser.router.component.html";
import styles from "./dom-parser.router.component.css";
...
@Router({
  ...
  route: {
    "": "/",
    "/": DomParserRouteComponent,
  },
})
@Component({
  template,
  styles: [styles],
  using: [DomParserRouteComponent, projectComponent],
})
export class DomParserRouterComponent extends ComponentRouterBase {
