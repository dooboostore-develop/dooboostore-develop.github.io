...
import bootFactory from "@simple-web-component/examples/commerce/src/bootFactory";
...
export default (w: Window,container: symbol) => {
  const tagName = 'app-commerce-example-project-page';
  ...
  class SwcDecoratorPage extends w.HTMLElement {
    private routerSubscription?: any;

    constructor(@Inject({symbol: RepositoryService.SYMBOL}) private repoService: RepositoryService) { super(); }
    ...
    config(el: SwcAppInterface) {
      const container = Symbol('commerce-example');
